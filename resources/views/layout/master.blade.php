            ...
            <ul class="nav nav-pills pull-right">
                ...
                <li>
                    @if(Auth::check())
                        ...
                        <a href="#" data-toggle="modal" data-target=".bs-example-modal-sm">
                            <span class="glyphicon glyphicon-off red" data-toggle="tooltip" title="Sair do Sistema"
                ...
                @else
                    <li>
                        ...
                        <a type="button" class="" id="myBtn" data-toggle="modal"
                           data-target="#myModalTeste">Registro</a>
                                        ...
                                        <form method="POST" class="form-horizontal" action="{{url('/auth/register')}}">
                                            ...
                                            <div class="form-group has-feedback">
                                                ...
                                                <input type="text" class="form-control" id="name"
                                                       value="{{ old('name') }}" placeholder="Enter Nome" name="name">
                                            ...
                                            <div class="form-group has-feedback">
                                                ...
                                                <input type="password" class="form-control" id="conf_psw" placeholder=""
                                            ...
                                            <button type="submit" class="btn btn-success btn-block"><span
                                                        class="glyphicon glyphicon-off"></span> Registrar
                                            </button>
                                        </form>
                                    </div>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h6 class="" id="mySmallModalLabel">Acesso ao sistema !</h6>
                        </div>
